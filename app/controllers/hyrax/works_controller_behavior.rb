...
module Hyrax
  module WorksControllerBehavior
    ...
    private
      ...
      def work_review
        if !params[:work_review_title].blank? && !params[:work_review_creator].blank?
          curation_concern.title   = [params[:work_review_title]]
          curation_concern.creator = [params[:work_review_creator]]
        end
      end
  end
end
