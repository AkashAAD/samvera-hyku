module Hyrax
  class CollectionPresenter
    ...
    # Metadata Methods
    delegate :title, :subject, :publisher, :keyword, :language, :embargo_release_date,
    ...
    def self.terms
      [:total_items, :size, :resource_type, :keyword, :license, :publisher, :date_created, :subject,
    ...
    def collection_type_badge
      content_tag(:span, hyku_colection_type(collection_type.title, current_ability.try(:current_user)), class: "label", style: "background-color: " + collection_type.badge_color + ";")
    end
